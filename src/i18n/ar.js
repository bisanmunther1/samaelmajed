...
const ar = {
  ...
  auth: {
    ...
    password_too_short: "كلمة المرور يجب أن تتجاوز 4 أحرف",
    ...
    go_register: "أنشئ حساباً",
    go_login: "سجّل الدخول",
    registered: "تم إنشاء الحساب! سجّل الدخول بحسابك الجديد.",
  },
  ...
  profile: {
    ...
    phone: "رقم الهاتف",
    bio: "نبذة",
    add_bio: "أضف نبذة عنك",
    photo: "الصورة",
    submit: "حفظ",
    my_trips: "رحلاتي",
    col_trip: "الرحلة",
    col_trip_date: "تاريخ الرحلة",
    col_price: "السعر",
    col_hotel: "الفندق",
    col_hotel_date: "تاريخ حجز الفندق",
    no_bookings: "لا توجد رحلات محجوزة بعد",
    load_profile_error: "تعذّر تحميل ملفك الشخصي.",
    load_bookings_error: "تعذّر تحميل حجوزاتك.",
    photo_too_large: "حجم الصورة يجب ألا يتجاوز 2 ميغابايت",
    saved: "تم تحديث ملفك الشخصي بنجاح.",
  },

  discount: {
    no_discounts: "لا توجد رحلات مخفّضة حالياً",
  },
  ...
  gallery: {
    ...
    view_all: "عرض الكل",
    view_less: "عرض أقل",
    no_match: "لا توجد رحلات مطابقة",
    load_error: "تعذّر تحميل الرحلات، يرجى المحاولة مرة أخرى.",
  },
  ...
  reserve: {
    ...
    next: "التالي",
    total: "الإجمالي",
    more_photos: "صور إضافية لـ {{trip}}",
    starting_points: "نقاط الانطلاق",
    by_plane: "بالطائرة",
    by_bus: "بالحافلة",
    no_options: "لا توجد خيارات متاحة لهذه الرحلة.",
    no_transport_needed: "لا أحتاج إلى مواصلات",
    starts_at: "يبدأ في: {{when}}",
    book_hotel: "احجز فندقاً",
    no_hotel: "بدون فندق",
    hotel_date: "تاريخ حجز الفندق:",
    hotel_prices_error: "تعذّر تحميل أسعار الفنادق لهذه الرحلة.",
    features_error: "تعذّر تحميل تفاصيل هذه الرحلة.",
    hotel_error: "تعذّر تحميل تفاصيل هذا الفندق.",
    transport_summary: "{{kind}} · {{name}}",
    no_transport_selected: "لم يتم اختيار مواصلات",
    no_hotel_selected: "لم يتم اختيار فندق",
    hotel_summary: "فندق · {{name}}، الدخول {{date}}",
    transport: "المواصلات",
    hotel: "الفندق",
    ready_to_pay: "جاهز للدفع",
    seed_booking: "إنشاء حجز (للتطوير فقط)",
    need_account: "ليس لديك حساب. يرجى تسجيل الدخول للحجز.",
    need_selection: "يجب اختيار نقطة انطلاق و/أو فندق.",
    booked: "تم الحجز بنجاح، رحلة سعيدة!",
    booking_error: "حدث خطأ أثناء حفظ حجزك. يرجى المحاولة مرة أخرى.",
